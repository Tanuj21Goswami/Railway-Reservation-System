                ...
                if (len == 4) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (canBook >= 0) 
                            {
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < Integer.parseInt(arr1[0]) && in < l; i++) {
                                        output[i] = String.valueOf(i + 1) + ")   " + arr1[i + 1] + " " + arr[in] + "    "
                                                + arr[in + 1];
                                        in = in + 2;
                                    }
                                    ...
                                    responseQuery=responseQuery+"S.No Name Coach Berth_No Berth_Type";
                                    for (int i = 0; i < Integer.parseInt((arr1[0])); i++) {
                                        responseQuery=responseQuery+"\n   ";
                            ...
                            {
                                responseQuery="Seat can not be booked!";
